...
import com.ibtdi.team.mkssab.Activity.AdvDetails;
...
/**
 * Created by team on 19-Jan-17.
 */

public class StoresAdvAdapter extends RecyclerView.Adapter<StoresAdvAdapter.AdvHolder> {
    ...
    public StoresAdvAdapter(Context context, ArrayList<AdvModel> models) {
        mArray=models;
        mContext=context;
