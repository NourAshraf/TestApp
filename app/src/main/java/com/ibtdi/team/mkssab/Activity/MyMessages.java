...
public class MyMessages extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onBackPressed() {
        Intent Home=new Intent(mContext, com.ibtdi.team.mkssab.Activity.Home.class);
        startActivity(Home);
        finish();
    }
